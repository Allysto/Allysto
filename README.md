...
### 📊 Key Metrics
- **R43,998.90** inventory value managed
- **3+ products** tracked with real-time updates
- **Transaction history** for all stock movements
- **Low stock alerts** for inventory optimization
...
- Cloud deployment (Render, Vercel, Neon.tech)
...
*Open to opportunities in software development, data analytics, and IT consulting.*
